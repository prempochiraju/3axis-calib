...
`-Z`. Each press starts a three-second settling period followed by 80 seconds
of CSV capture. The ADXL362 ODR is explicitly configured to its supported
12.5 Hz setting, and the application records 1,000 samples per pose at 12.5 Hz.
